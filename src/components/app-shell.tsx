    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { to: "/production/produce", label: "New Production", icon: Play, permission: "production.access" },
          { to: "/production/batches", label: "Batches", icon: Factory, permission: "production.access" },
          { to: "/recipes", label: "Recipes", icon: ChefHat, permission: "production.recipes.view" },
          { to: "/production/wastage", label: "Wastage Log", icon: Undo2, permission: "production.wastage.manage" },
          { to: "/production/repurpose", label: "Wastage Management", icon: Recycle, permission: "production.repurpose" },
