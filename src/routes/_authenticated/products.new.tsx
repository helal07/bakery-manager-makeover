...
import { saveRecipe, type Ingredient } from "@/lib/recipe-store";
...
function NewProduct() {
  ...
  const promptAddCategory = async () => {
    ...
    try {
      ...
      setCats(cs);
      setForm((f) => ({ ...f, category: name, sku: genSku(name, f.name) }));
  ...
  return (
    <AppShell
      title="Add Product"
      subtitle="Create a new product with pricing, stock and recipe"
      actions={
        <Link
          to="/products"
              ...
              <div className="sm:col-span-2">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    setForm((f) => ({ ...f, name, sku: genSku(f.category, name) }));
                  }}
                ...
                <div className="flex gap-1">
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      setForm((f) => ({ ...f, category, sku: genSku(category, f.name) }));
                    }}
