...
4. **Duplicate warning at creation**
  When you save a batch for the same product, same quantity, within the same day, you get a confirmation prompt ("A nearly identical batch was saved N minutes ago — save anyway?") so accidental double-saves stop before they happen.
5. **Permissions**
